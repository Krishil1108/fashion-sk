...
const collections = [
  {
    ...
    fallback: "https://images.unsplash.com/photo-1434389678232-0678a58cbd37?q=80&w=1400&auto=format&fit=crop",
    link: "/menspage",
  },
  {
    id: 2,
    ...
    fallback: "https://images.unsplash.com/photo-1523398002811-999aa8d9512e?q=80&w=1400&auto=format&fit=crop",
    link: "/womenspage",
  },
  {
    id: 3,
    ...
    fallback: "https://images.unsplash.com/photo-1539008835657-9e8e9680c956?q=80&w=1400&auto=format&fit=crop",
    link: "/studiopage",
  },
];
  ...
  return (
    <Link href={collection.link}
      ...
      style={{
        ...
        transition: `opacity 0.9s ease ${index * 0.12}s, transform 0.9s cubic-bezier(0.22,1,0.36,1) ${index * 0.12}s, box-shadow 0.4s ease, border-color 0.4s ease`,
        boxShadow: hovered
          ? `0 0 0 1px ${collection.badgeColor}40, var(--shadow-lg)`
          : "var(--shadow-sm)",
        border: hovered ? `1px solid ${collection.badgeColor}30` : "1px solid var(--card-border)",
      }}
    >
      ...
      <img
        ...
        loading="lazy"
        decoding="async"
        onError={e => { e.currentTarget.src = collection.fallback; }}
        style={{
      ...
      <div style={{
        ...
        color: collection.badgeColor === "var(--gold)" ? "var(--text-inverted)" : "white",
        padding: "4px 14px", borderRadius: "999px",
        fontSize: "9px", fontWeight: 900, letterSpacing: "2px",
        textTransform: "uppercase", fontFamily: "var(--font-secondary)",
      ...
      <div style={{
        ...
        <p style={{
          ...
          marginBottom: "16px", fontFamily: "var(--font-secondary)",
          opacity: hovered ? 1 : 0,
    ...
    <section style={{
      ...
      <div style={{ maxWidth: "1600px", margin: "0 auto", padding: "0 5vw" }}>
        ...
        <div ref={headerRef} style={{
          ...
          onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px) scale(1.03)"; e.currentTarget.style.background = "var(--gold)"; e.currentTarget.style.color = "var(--text-inverted)"; }}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              color: "var(--gold)", fontSize: "9px", fontWeight: 800, letterSpacing: "3px",
            ...
            <p style={{
              ...
              fontFamily: "var(--font-primary)", letterSpacing: "-0.5px",
            }}>Use Code <span style={{ color: "var(--gold)" }}>MYNTRA300</span><br />Save Rs. 300</p>
            <Link href="/menspage" style={{
              color: "var(--gold)", fontWeight: 800, fontSize: "12px",
        ...
        <div style={{
          ...
          <p style={{
            ...
            letterSpacing: "3px", color: "var(--text-muted)", textTransform: "uppercase",
            marginBottom: "32px", fontFamily: "var(--font-secondary)",
          }}>
            Brands We Carry
          </p>
          <div style={{
            ...
            {partners.map(brand => (
              <span key={brand} style={{
                color: "var(--text-muted)", fontSize: "14px", fontWeight: 900,
