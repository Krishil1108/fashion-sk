      ...
      <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: "24px" }}>
        ...
        {brands.length > 0 && (
          <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "20px" }}>
            <h4 style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-muted)", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "14px" }}>Brands</h4>
                ...
                <label key={brand} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
                  <div
                    ...
                    style={{
                      ...
                      border: selectedBrands.includes(brand) ? "none" : "2px solid var(--border-color)",
                      background: selectedBrands.includes(brand) ? "var(--accent)" : "transparent",
                  ...
                  <span style={{ fontSize: "14px", color: "var(--text-secondary)", fontWeight: 500 }}>{brand}</span>
                </label>
              ))}
            </div>
          </div>
        ...
        <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "12px" }}>
            <h4 style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-muted)", letterSpacing: "1.5px", textTransform: "uppercase" }}>Max Price</h4>
            <span style={{ fontSize: "13px", fontWeight: 800, color: "var(--accent)" }}>Rs. {priceRange.toLocaleString()}</span>
          </div>
          <input
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: "6px" }}>
            <span style={{ fontSize: "11px", color: "var(--text-muted)" }}>Rs. 500</span>
            <span style={{ fontSize: "11px", color: "var(--text-muted)" }}>Rs. 10,000</span>
          </div>
        </div>

        {/* Sizes */}
        <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "20px" }}>
          <h4 style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-muted)", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "12px" }}>Sizes</h4>
        ...
        {/* Rating */}
        <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: "20px" }}>
          <h4 style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-muted)", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "12px" }}>Min Rating</h4>
            ...
            {[4, 3, 2].map(stars => (
              <button
                ...
                style={{
                  ...
                  background: minRating === stars ? "var(--accent-light)" : "transparent",
                  border: minRating === stars ? "1px solid var(--accent)" : "1px solid transparent",
              ...
              >
                ...
                <span style={{ fontSize: "13px", color: "var(--text-secondary)", fontWeight: 600 }}>& Up</span>
              </button>
            ))}
          </div>
        </div>
  ...
  return (
    <div style={{ maxWidth: "1600px", margin: "0 auto", padding: "40px 5vw" }}>
      ...
      <div style={{ marginBottom: "40px" }}>
        <span style={{ display: "block", color: "var(--accent)", fontSize: "11px", fontWeight: 800, letterSpacing: "3px", textTransform: "uppercase", marginBottom: "8px" }}>
          Aura Collection
        </span>
        <div style={{ display: "flex", alignItems: "baseline", gap: "16px", flexWrap: "wrap" }}>
          <h1 style={{
            fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 900, color: "var(--text-primary)",
      ...
      <div style={{ display: "flex", gap: "32px", alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            display: "flex", alignItems: "center", justifyContent: "space-between",
            background: "var(--bg-card)", borderRadius: "16px", padding: "14px 20px",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <select
                ...
                style={{
                  ...
                  border: "1.5px solid var(--border-color)", fontSize: "13px", fontWeight: 700,
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    border: "1.5px solid",
                    borderColor: layoutMode === mode ? "var(--accent)" : "var(--border-color)",
                    background: layoutMode === mode ? "var(--accent)" : "var(--bg-card)",
                    color: layoutMode === mode ? "white" : "var(--text-muted)",
                    display: "flex", alignItems: "center", justifyContent: "center",
          ...
          {filteredProducts.length === 0 && (
            <div style={{ textAlign: "center", padding: "80px 20px" }}>
              <ShieldAlert size={48} color="var(--accent)" style={{ margin: "0 auto 16px" }} />
              <h3 style={{ fontSize: "18px", fontWeight: 800, color: "var(--text-primary)", marginBottom: "8px" }}>No products match</h3>
          ...
          <div style={{
            ...
            >
              <div style={{ position: "relative", borderRadius: "24px 0 0 24px", overflow: "hidden", minHeight: "400px" }}>
                <img src={selectedQuickView.image_url} alt={selectedQuickView.para} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
              <div style={{ padding: "36px 32px", display: "flex", flexDirection: "column" }}>
                <button
                  ...
                  style={{
                    ...
                    border: "none", background: "var(--bg-secondary)", cursor: "pointer",
                    display: "flex", alignItems: "center", justifyContent: "center",
                ...
                <span style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-muted)", letterSpacing: "2px", textTransform: "uppercase", marginBottom: "8px" }}>
                  {selectedQuickView.brand}
                </span>
                <h2 style={{ fontSize: "22px", fontWeight: 900, color: "var(--text-primary)", lineHeight: 1.3, marginBottom: "16px" }}>
                  {selectedQuickView.para}
                </h2>
                <div style={{ display: "flex", alignItems: "baseline", gap: "12px", marginBottom: "24px" }}>
                  <span style={{ fontSize: "24px", fontWeight: 900, color: "var(--text-primary)" }}>{selectedQuickView.price}</span>
                  {selectedQuickView.strikedoffprice && (
                    <span style={{ fontSize: "14px", color: "var(--text-muted)", textDecoration: "line-through" }}>{selectedQuickView.strikedoffprice}</span>
                  )}
                </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: `opacity 0.6s ease ${(index % 12) * 0.04}s, transform 0.6s ease ${(index % 12) * 0.04}s, box-shadow 0.4s ease, border-color 0.4s ease`,
        boxShadow: hovered ? "var(--shadow-md)" : "var(--shadow-xs)",
      }}
    >
      {/* Image */}
      <div style={{ position: "relative", aspectRatio: "3/4", overflow: "hidden", background: "var(--bg-secondary)" }}>
        <img
          src={elem.image_url}
          alt={elem.para}
          loading="lazy"
        ...
        >
          <Heart size={15} fill={wishlisted ? "var(--accent)" : "none"} color={wishlisted ? "var(--accent)" : "var(--text-secondary)"} />
        </button>
      ...
      <div style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "6px", flex: 1 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{
            ...
            background: "var(--bg-secondary)", padding: "2px 6px", borderRadius: "6px",
          }}>
            <Star size={11} fill="#fbbf24" color="#fbbf24" />
            <span style={{ fontSize: "11px", fontWeight: 800, color: "var(--text-secondary)" }}>{elem.rating}</span>
          </div>
        </div>
        <p style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: "17px", fontWeight: 900, color: "var(--text-primary)" }}>{elem.price}</div>
            {elem.strikedoffprice && (
              <div style={{ fontSize: "11px", color: "var(--text-muted)", textDecoration: "line-through", marginTop: "1px" }}>
                {elem.strikedoffprice}
              </div>
            )}
          </div>
